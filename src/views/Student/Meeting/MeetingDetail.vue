<template>
  <v-card class="ma-2 elevation-0 overflow-y-auto transparent" tile :height="windowHeight">
    <v-container>
      <v-row>
        <v-col cols="12" class="py-0">
          <v-alert border="left" colored-border color="primary" class="my-0 py-0 elevation-2" icon="mdi-calendar-clock" prominent>
            <v-row align="center">
              ...
              <v-col class="shrink">
                <v-icon
                  v-if="meetingData.MeetingType != 1 && meetingData.RequestStatus == 1"
                  class="mr-2"
                  color="green"
        ...
        <v-col cols="8">
          <v-card colored-border class="ma-0">
            ...
            <v-card-actions class="mx-2">
              ...
              <v-btn text to="/student/meeting">กลับ</v-btn>
            </v-card-actions>
          </v-card>
        </v-col>
      </v-row>

...
export async function IsCompleteAllForm(pProjectID,pIsProject) {
  return await HTTP.get(`form/sent/iscompleteall?projectid=${pProjectID}&project=${pIsProject}`).then(res => {

...
(NULL, 1, 2, 'นักศิกษาเพิ่มโครงงาน', 'ขออนุมัติเป็นที่ปรึกษา {ProjectName}', 'สร้างกลุ่ม {ProjectName} และเพิ่มคุณเป็นอาจารย์ที่ปรึกษา', '/teacher/advisor_req', NULL, NULL, NULL, NULL),
-- อาจารย์สร้างกลุ่ม
